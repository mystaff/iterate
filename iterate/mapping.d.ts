export = Iterate__mapping;
/**
  @class
  Sync iteration mapping methods of {@linkcode Iterate} class
  @hideconstructor
*/
declare class Iterate__mapping extends Iterate__aggregation {
    /**
    ...
    */
    map(this: Iterate, ...mappers: MapperParam[]): Iterate;
    /**
    ...
    */
    flatMap(this: Iterate, ...mappers: MapperParam[]): Iterate;
    /**
    ...
    */
    dim(this: Iterate, ...iterables: (Iterable<any> | Function)[]): Iterate;
}
import Iterate__aggregation = require("./aggregation");
